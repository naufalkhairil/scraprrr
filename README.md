...
├── docker-compose.yml          # Selenium Grid Docker configuration
├── README.md                   # This file
│
├── src/
...
│       ├── page.py             # Page Object Model (HomePage, ResultsPage)
│       ├── extractor.py        # Ticket data extraction logic
...
### 1. Start Docker Selenium Server
...
Airport mappings are stored in `mappings/airports.json` at the project root. You can easily add or modify airports by editing this file.
...
Edit `airports.json` to add new airports:
